...
- [QoF v1.1.1's Changelog](#qof-v111s-changelog)- [Pack Info](#pack-info)
...
aitji, the idea is already clear and useful. I just cleaned the wording a bit and normalized the names so the table reads nicely and consistently.
